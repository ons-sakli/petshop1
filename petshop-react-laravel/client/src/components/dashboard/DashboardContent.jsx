...
const DashboardContent = () => {
    return (
        <div className=''>
         <div className='bg-pastel-pink m-7 p-6' style={{ backgroundColor: '#FFEBF4' }}>
    <div className='text-4xl text-gray-800 font-medium'>Hello, Administrator.😃</div>
    <div className='mt-4'>These are the stats for today, safepet</div>
</div>
            ...
            <div className='flex m-7 space-x-6'>
                <div className='w-1/2 bg-white p-4'>
                    ...
                    <h2 className="font-bold text-xl text-gray-700">safepet</h2>
