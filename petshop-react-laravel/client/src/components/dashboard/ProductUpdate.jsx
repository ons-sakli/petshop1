        ...
        <div className="w-3/4">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="flex flex-col space-y-1 mb-8">
              ...
              >
                <option value=""></option>
                <option value="desktop">savepet</option>
                <option value="laptop">petlover</option>
                <option value="printer">Pets</option>
                <option value="scanner">dogs</option>
                <option value="tablet">T</option>
                <option value="monitor">autres</option>
              </select>
